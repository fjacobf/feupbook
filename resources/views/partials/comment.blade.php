@if ($comment->previous == null)
    <div class="d-flex flex-column ms-3">
        ...
        @can('create', [App\Models\Comment::class, $post])
            ...
            <div style="gap:10px; font-size: 0.8rem;" class="d-flex align-items-center mb-3">
...
@foreach ($comment->replies()->orderBy('created_at', 'desc')->get() as $reply)
    <div class="d-flex flex-column ms-5 mb-3">
        <div class="d-flex justify-content-between">
            <div class="d-flex align-items-center">
                <div class="card-text">
                    <img src="{{ asset('images/profile_pics/' . $reply->user->avatar) }}" class="rounded-circle" alt="User avatar" style="width: 25px; height: 25px;">
